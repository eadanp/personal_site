      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:gap-8">
        ...
        <div class="flex flex-col gap-4 sm:gap-8">
          ...
          <p>
            ...
            > where I help solve complex problems and build scalable solutions. I
            have experience with Python, TypeScript, C# and C++ as well as cloud
            technologies like AWS and GCP. I am always looking for new challenges
